      ...
      <div className="flex justify-center gap-8 pt-8">
        <div className="bg-white rounded-lg shadow-[4px_4px_4px_0px_#00000040] w-1/2 flex justify-center flex-col">
          <span className="space-y-4 p-2 pb-6 pt-6 mx-6">
            ...
            <input type="text" placeholder="Name of the subjects" className="p-2 pl-4 w-full rounded-full border border-gray-300 " />
          </span>
          <div className="py-10 flex justify-center items-center">
            <button className="p-2 bg-pink-400 rounded-full px-6 text-white">Create</button>
          </div>
