...
function EditStudent() {
    ...
    const sendData = async () => {
      try {
        const res = await api.put(
          `/students/${initialFormValues.id}/update/`,
          formDataToSend
        );
        // console.log(res);
  ...
  return initialFormValues && classes ? (
    <div className="bg-pink-100 min-h-screen p-8">
      ...
      <div className="my-8 text-center">
        <h2 className="text-3xl font-bold text-black">Edit Student Details</h2>
      </div>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-6  gap-4 mt-6">
            ...
            <div className="mb-4 relative">
              ...
              >
                Change Photo <MdOutlineFileUpload />
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-6  gap-4">
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 block w-full p-2 border border-gray-300 rounded-3xl">
                {
                  classes.find(
                    (c) => c.id == initialFormValues.classOfAdmission
                  )?.name
                }
              </div>
              <div
                className="w-full text-center text-blue-500 underline hover:text-gray-700 cursor-pointer "
                onClick={() => navigate("/students/promoteStudents")}
              >
                Promote student ?
              </div>
            </div>
