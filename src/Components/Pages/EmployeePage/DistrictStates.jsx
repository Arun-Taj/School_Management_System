...
import statesDistricts from '../SignUp&SignIn/statesDistricts.json'  // Import the JSON file

const DistrictStates = ({ setFieldValue, selectedState, selectedDistrict }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <div>
        <label htmlFor="" className='font-sans text-base font-bold leading-5 text-left'>State</label>
        <Field
          as="select"
          name="state"
      ...
      <div>
        <label htmlFor="" className='font-sans text-base font-bold leading-5 text-left'>District</label>
        <Field
          as="select"
          name="district"
          className="w-full bg-white border border-[#5011DD] rounded-3xl px-4 py-2"
